    ...
    public Map<String, String> searchByAddress(String addressText) {
        ...
        for(String key: POSTALCODE_MAP.keySet()){
            if(POSTALCODE_MAP.get(key).contains(addressText)){
                rtMap.put(key, POSTALCODE_MAP.get(key));
//                System.out.println("key:" + key + " value:" + POSTALCODE_MAP.get(key));
            }
        }
...
//        app.searchByCode("473");
//        app.searchByCode("4700521");
//        app.searchByAddress("西");
//        app.searchByAddress("星ケ丘");
    }
